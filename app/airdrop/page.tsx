  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-indigo-950">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6 pt-20">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-4 bg-zinc-800/50 border border-zinc-700/50 rounded-full text-sm text-zinc-300 backdrop-blur-sm">
          ...
          <div className="bg-zinc-900/60 backdrop-blur-xl border border-zinc-800/50 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  max="5"
                  step="0.1"
                  className="w-full px-4 py-4 bg-zinc-800/50 border border-zinc-700/50 rounded-2xl text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all duration-200 text-lg font-semibold"
              ...
              <div className="grid grid-cols-4 gap-2">
                {quickAmounts.map((quickAmount) => (
                  <button
                    ...
                    disabled={!connected || isLoading}
                    className="px-3 py-2 bg-zinc-800/50 hover:bg-zinc-700/50 border border-zinc-700/50 hover:border-zinc-600/50 rounded-xl text-zinc-300 hover:text-white transition-all duration-200 text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {quickAmount}
                  </button>
                ))}
            ...
            {/* Info Box */}
            <div className="mt-6 p-4 bg-zinc-800/30 border border-zinc-700/30 rounded-2xl">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-4">
            ...
            <div className="p-6 bg-zinc-900/40 border border-zinc-800/50 rounded-2xl backdrop-blur-sm">
              <div className="text-2xl mb-3">🔄</div>
              <h3 className="text-white font-bold mb-2">Unlimited Testing</h3>
              <p className="text-zinc-400 text-sm">
